...
<div class="game">
    <div>
        ...
        <h3>게임 장르 : {game.gameDetail.genres[0].name}</h3>
        <h3>게임 테마 : {game.gameDetail.themes[0].name}</h3>
        <h3>게임 플랫폼 : {game.gameDetail.platforms[0].name}</h3>


        <h3>출시일 : {game.gameDetail.first_release_date}</h3>
        <h3>연관 기업 : {game.gameDetail.involved_companies[0].company[0].name}</h3>

        <h3>game.screenshots 인게임 샷</h3>
